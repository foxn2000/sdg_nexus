...
class AdaptiveController:
    ...
    def __init__(
        ...
        self._pending_releases: int = 0  # Track pending semaphore releases
    ...
    def _update_semaphore(self, old_value: int, new_value: int) -> None:
        ...
        # Note: Decreasing capacity is more complex and happens naturally
        # as we don't release permits when workers complete
...
class AdaptiveConcurrencyManager:
    ...
    @property
    def semaphore(self) -> asyncio.Semaphore:
        """Get concurrency-limiting semaphore."""
