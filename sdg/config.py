...
class OutputDef:
    ...
    # logic出力用
    from_: Optional[str] = None  # boolean|value|join|count|any|all|first|last|list|var|accumulator
...
def load_config(path: str) -> SDGConfig:
    ...
    if "functions" in data:
        ...
        if "python" in funcs_data:
            functions["python"] = [FunctionDef.from_dict(f) for f in funcs_data["python"]]
